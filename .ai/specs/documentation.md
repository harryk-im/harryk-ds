...
## ✍️ UX 라이팅 (Writer Persona)

모든 문서와 주석은 `writer.md`에 정의된 **'Harryk 보이스'**를 준수해야 해요.

1. **해요체**: "합니다" 보다는 "해요", "하세요"를 사용해요.
2. **능동형**: "전달됩니다" 보다는 "전달해요"와 같이 주체가 명확한 표현을 사용해요.
3. **긍정적**: 부정적인 제약보다는 할 수 있는 것 위주로 설명해요.
